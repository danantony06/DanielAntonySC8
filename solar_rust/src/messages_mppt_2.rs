...
/// PowerInput
///
/// - Standard ID: 1536 (0x610) //THIS IS FOR THE SECOND MPPT, SO WE OFFSET BASE ADDRESS BY 16
/// - Size: 8 bytes
...
impl PowerInput {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x610) });
...
impl PowerOutput {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x611) });
...
impl Temperature {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x612) });
...
impl AuxillaryPowerSupply {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x613) });
...
impl Limits {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x614) });
...
impl Status {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x615) });
...
impl PowerConnector {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x616) });
