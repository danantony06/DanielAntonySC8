...
/// PowerInput
///
/// - Standard ID: 1536 (0x620) //THIS IS FOR THE THIRD MPPT, SO WE OFFSET BASE ADDRESS of mppt_2 BY 16
/// - Size: 8 bytes
...
impl PowerInput {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x620) });
...
impl PowerOutput {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x621) });
...
impl Temperature {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x622) });
...
impl AuxillaryPowerSupply {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x623) });
...
impl Limits {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x624) });
...
impl Status {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x625) });
...
impl PowerConnector {
    pub const MESSAGE_ID: embedded_can::Id =
        Id::Standard(unsafe { StandardId::new_unchecked(0x626) });
